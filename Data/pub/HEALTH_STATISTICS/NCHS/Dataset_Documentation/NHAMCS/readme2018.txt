         2018 National Hospital Ambulatory Medical Care Survey Data Files
    ...
    laws including Section 308(d) Public Health Service Act [42 U.S.C. 242m(d)] 
    and the Confidential Information Protection and Statistical Efficiency Act or 
    CIPSEA [Pub. L. No. 115-435, 132 Stat. 5529 § 302]. These confidentiality laws 
    state the data collected by NCHS may be used only for statistical reporting and 
   ...
   * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   ...
   The Emergency Department (ED) component of the 2018 National Hospital  
   ...
   2) Download to the new folder the file ED2018.zip from the FTP server: 
   ...
   ED2018.zip        NHAMCS Emergency Department file      1.9 MB     46.7 MB

   doc18_ed.pdf      NHAMCS ED documentation file                      1.5 MB
   ...
   contact the Ambulatory and Hospital Care Statistics Branch at (301) 458-4600
   or ambcare@cdc.gov.
